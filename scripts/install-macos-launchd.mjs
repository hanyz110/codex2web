...
async function main() {
  ...
  await writeEnvFile(envPath, {
    ...
    CODEX2WEB_CLOUDFLARE_PROTOCOL: process.env.CODEX2WEB_CLOUDFLARE_PROTOCOL || "http2",
    CODEX2WEB_CLOUDFLARE_TUNNEL_ID: tunnelId,
    CODEX2WEB_CLOUDFLARE_TUNNEL_NAME: tunnelName,
    CODEX2WEB_EXTERNAL_PORT: port,
    CODEX2WEB_PUBLIC_WATCHDOG_FAILURES: process.env.CODEX2WEB_PUBLIC_WATCHDOG_FAILURES || "6",
    CODEX2WEB_PUBLIC_WATCHDOG_INTERVAL_MS: process.env.CODEX2WEB_PUBLIC_WATCHDOG_INTERVAL_MS || "15000",
    CODEX2WEB_PUBLIC_WATCHDOG_RESTART_COOLDOWN_MS:
      process.env.CODEX2WEB_PUBLIC_WATCHDOG_RESTART_COOLDOWN_MS || "120000",
    CODEX2WEB_PUBLIC_WATCHDOG_TIMEOUT_MS: process.env.CODEX2WEB_PUBLIC_WATCHDOG_TIMEOUT_MS || "10000",
